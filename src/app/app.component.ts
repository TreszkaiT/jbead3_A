...
export class AppComponent implements OnInit {
  ...
  public ngOnInit(): void {
    ...
    this.translate('hu'); // Ripple animation in button (középröl kör irányba mint egy vízbe dobott kő fehér glória mozog kifelé)
  ...
  public translate(lang: string) {
    ...
    this.translateService.onLangChange.subscribe((event) => {
      this.primengConfig.setTranslation(event.translations);
      this.createItems(event.translations);
    });
  }

  private createItems(translation: any): void {
    this.items = [
      {
        label: 'Home',
        routerLink: 'home',
  ...
  private switchTheme(theme: string) {
    let themeLink = this.document.getElementById(
      // az index.html HEAD-ban az id megváltoztatása: id="app-theme"
      'app-theme'
    ) as HTMLLinkElement;
